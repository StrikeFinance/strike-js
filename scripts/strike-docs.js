...
intro += '# Strike.js\n\n';
intro += '## Introduction\n\n';
intro += '[Strike.js](https://github.com/StrikeFinance/strike-js) is a ';
intro += 'JavaScript SDK for Ethereum and the Strike Protocol. It wraps ';
...
intro += ' message in the Development channel of the Strike Discord.\n\n';
intro += '</section>\n\n';
