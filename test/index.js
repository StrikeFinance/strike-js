...
// Source Files
const strk = require('./strk.test.js');
const comptroller = require('./comptroller.test.js');
const sToken = require('./sToken.test.js');
...
describe('Strike.js', function () {
  ...
  describe('./src/strk.ts', strk.bind(this, acc));
  describe('./src/comptroller.ts', comptroller.bind(this, acc));
  describe('./src/sToken.ts', sToken.bind(this, acc));
